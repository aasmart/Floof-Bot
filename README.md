...
[`src/index.ts`](./src/index.ts) calls the request handler in [`src/bot.ts`](./src/bot.ts), and will return the [request method](https://developer.mozilla.org/en-US/docs/Web/API/Request/method) for the given request.
